...
ctr_left = Frame(center, bg='blue', width=50, height=190).grid(column = 0, row = 1, rowspan = 2)
ctr_mid = Frame(center, bg='yellow', height=190, padx=3, pady=3).grid(column = 1, row=1, rowspan=2)
ctr_right = Frame(center, bg='green', width=50, height=190, padx=3, pady=3).grid(column = 2, row=1, rowspan=2)
